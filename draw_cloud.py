    ...
    if os.path.exists(m_path_1):
        ...
        try:
            wc1 = WordCloud(
                ...
                max_words=4000,          # 畫布變大了，字數也要給更多才能填滿
                max_font_size=250,       # 最大字體也要跟著放大
                min_font_size=8,         
                repeat=True,             
                colormap='inferno'
            )
            ...
            plt.figure(figsize=(20, 20)) # 給它一個超大繪圖視窗
            plt.imshow(out1, interpolation="bilinear") # 畫布夠大，用 bilinear 邊緣會很平滑
            plt.axis("off")
